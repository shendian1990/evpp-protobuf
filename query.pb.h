...
inline ::std::string* Query::release_questioner() {
  ...
  clear_has_questioner();
  return questioner_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* Answer::release_answerer() {
  ...
  clear_has_answerer();
  return answerer_.ReleaseNonDefaultNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
